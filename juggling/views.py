...
from juggling.video_processing.video_processor import process_video
from .serializers import VideoProcessingSerializer
from django.conf import settings  # Import settings for generating URL
    ...
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            with NamedTemporaryFile() as temp_file:
                ...
                target_video_filename = f"{username}_juggling_{date_today}.mp4"   # or any other desired video extension
                ...
                try:
                    ...
                    count = process_video(temp_file.name, target_video_path)
                    ...
                    # Return response with username, count, and target video path
                    return Response({'username': username, 'count': count, 'target_video_path': target_video_url}, status=status.HTTP_200_OK)
