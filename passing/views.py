...
from passing.video_processing.video_processor import process_video
    ...
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            with NamedTemporaryFile() as temp_file:
                ...
                target_video_filename = f"{username}_passing_{date_today}.mp4"   # or any other desired video extension
                ...
                try:
                    ...
                    ball_hit_counter, ball_miss_counter = process_video(temp_file.name, target_video_path)
                    ...
                    # Return response with username, ball_hit_counter, ball_miss_counter, and target video path
                    return Response({
                        'username': username, 
                        'ball_hit_counter': ball_hit_counter, 
                        'ball_miss_counter': ball_miss_counter, 
