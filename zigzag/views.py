...
from zigzag.video_processing.video_processor import process_video
    ...
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            with NamedTemporaryFile() as temp_file:
                ...
                target_video_filename = f"{username}_zigzag_{date_today}.mp4"   # or any other desired video extension
                ...
                try:
                    ...
                    time_taken = process_video(temp_file.name, target_video_path)
                    ...
                    # Return response with username, time_taken, and target video path
                    return Response({'username': username, 'time_taken': time_taken, 'target_video_path': target_video_url}, status=status.HTTP_200_OK)
